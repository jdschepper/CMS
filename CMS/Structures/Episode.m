...
@synthesize aired = mAired;
@synthesize season = mSeason;
@synthesize episode = mEpisode;
...
@synthesize poster = mPoster;
@synthesize posterURL = mPosterURL;
@synthesize localFile = mLocalFile;
